...
void run_benchmark(const ascii *title, void (*kernel)(f64 *restrict, f64 *restrict, f64 *restrict, u64), u64 n, u64 r);
...
int main(int argc, char **argv) {
    ...
    run_benchmark("UNROLL", dgemm_unroll_x4, n, r);
    run_benchmark("UNROLLx8", dgemm_unroll_x8, n, r); 
...
void run_benchmark(const ascii *title, void (*kernel)(f64 *restrict, f64 *restrict, f64 *restrict, u64), u64 n, u64 r) {
    ...
    printf("%10s; %15.3lf; %15.3lf; %15.3lf; %10llu; %10llu; %15.3lf; %15.3lf; %15.3lf; %15.3lf (%6.3lf %%); %10.3lf\n",
           title, 3 * size_kib, 3 * size_mib, 3 * size_gib, n, r, min, max, mean, dev, (dev * 100.0 / mean), mbps);
